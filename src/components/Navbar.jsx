          ...
          <div className=" absolute right-[10px] sm:right-[30px] flex items-center justify-center gap-[15px] md:gap-[2vw] ">
            ...
            <div className="relative cursor-pointer w-[40px] h-[40px] flex justify-center items-center bg-[#d9d9d938] rounded-full">
              <Link href={"/cart"}>
                ...
                <div className="absolute top-[0px] right-[0px] w-[13px] h-[13px] rounded-full bg-white text-[9px] font-medium flex items-center justify-center text-center ">
                  {cartLength}
                </div>
              </Link>
            </div>
            <div
              className={`flex md:hidden z-[1000]  cursor-pointer transition-half-second gap-[6px] flex-col bg-[#d9d9d938] w-[40px] h-[40px] rounded-full items-center justify-center`}
              onClick={() => {
                setNavOpen(!navOpen);
              }}
            >
              <span
                className={` transition-all duration-300 flex w-[22px] h-[2px] bg-white trans ${
                  navOpen
                    ? " origin-top-left translate-x-[4px] rotate-[45deg] "
                    : ""
                }  `}
              ></span>
              <span
                ...
                } trans flex w-[22px] h-[2px] bg-white`}
              ></span>
              <span
                className={` transition-all duration-300 flex w-[22px] h-[2px] bg-white trans ${
                  navOpen
                    ? " origin-bottom-left translate-x-[4px] -rotate-[45deg] "
                    : ""
                } `}
              ></span>
            </div>
